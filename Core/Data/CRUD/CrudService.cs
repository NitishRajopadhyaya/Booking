...
namespace Core.Data.CRUD
{
    public class CrudService<T>
    {
        ...
        public virtual async Task<T> GetAsync(IDbConnection db, object id)
        {
            return await db.GetAsync<T>(id);
        ...
        {
            {
                ...
                {
                    await db.OpenAsync();
                      var a=await db.GetListAsync<T>(whereConditions);
                    return a;
        ...
        public virtual async Task<int> UpdateAsync(IDbConnection db, IDbTransaction transaction, object entityToUpdate, string condition, int? commandTimeout, object parameters = null)
        {
            {

                return await db.UpdateAsync(entityToUpdate, condition, parameters, transaction, commandTimeout, null);
        ...
        public virtual async Task<int> UpdateAsDeletedAsync(T entityToDelete)
        {
            using (var db = (DbConnection)DbFactory.GetConnection())
            {
                await db.OpenAsync();
                return await db.UpdateAsync(entityToDelete);

            }
        }
        //TODO
        public virtual async Task<int> UpdateAsDeletedAsync(IDbConnection db, object id, int? commandTimeout)
        {
        ...
        public virtual async Task<int> DeleteAsync(IDbConnection db, IDbTransaction transaction, object id)
        {
            return await db.DeleteAsync<T>(id, transaction, null);


        }
        public virtual async Task<int> DeleteAsync(IDbConnection db, IDbTransaction transaction, string condition, object parameters = null)
        {
            return await db.DeleteAsync<T>(condition, parameters, transaction);
        ...
        public virtual async Task<int> RecordCountAsync(IDbConnection db, string conditions = "",
            object parameters = null)
        {
            return await db.RecordCountAsync<T>(conditions, parameters);
