...
namespace Security.Stores
{
    public class UserStore<TUser, TKey, TUserRole, TRoleClaim, TUserClaim, TUserLogin, TRole> :
        ...
        where TUser : DynamicIdentityUser<TKey, TUserClaim, TUserRole, TUserLogin>
        where TKey : IEquatable<TKey>
        where TUserRole : DynamicIdentityUserRole<TKey>
        where TRoleClaim : DynamicIdentityRoleClaim<TKey>
        where TUserClaim : DynamicIdentityUserClaim<TKey>
        where TUserLogin : DynamicIdentityUserLogin<TKey>
        where TRole : DynamicIdentityRole<TKey, TUserRole, TRoleClaim>
    {
        private readonly IIdentityUserService _userService;
        private readonly IIdentityRoleService _roleService;

        public UserStore(IIdentityUserService identityUserService
                         ,IIdentityRoleService identityRoleService)
        {
            _userService = identityUserService;
            _roleService = identityRoleService;
        ...
        public async Task<IdentityResult> CreateAsync(TUser user, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var model = user as Models.IdentityUser;
        ...
        public async Task<TUser> FindByNameAsync(string normalizedUserName, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var result = await _userService.UserService.GetAsync("Where Email=@UserName", new { UserName = normalizedUserName });
        ...
        public async Task<IList<string>> GetRolesAsync(TUser user, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var identityUser = user as Models.IdentityUser;
                var userRoles = await _userService.UserRoleService.GetListAsync("Where UserId=@UserId",
                    new { UserId = user.Id });
                var roles = await _userService.GetUserRoleNamesById(identityUser.Id);
